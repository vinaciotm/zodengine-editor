...
export const sfx = {
  ...
  // open project — Random 118
  suck() {
    zzfx(1,.05,560,.02,.08,.08,0,3.8,6,0,0,0,0,0,19,0,0,.85,.01,0,0);
  },
  ...
  // logo click — Random 96
  win() {
    zzfx(1.1,.05,19,.01,.1,.08,0,3.9,0,24,-155,0,0,0,0,0,0,.71,.16,0,176);
  },
